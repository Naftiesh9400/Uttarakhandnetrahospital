          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="flex-1 space-y-8 max-w-2xl text-center lg:text-left">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm text-white text-sm font-medium border border-white/20 mx-auto lg:mx-0">
              ...
              <div className="pt-4 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Button 
                  className="h-auto py-3 px-6 bg-white hover:bg-blue-50 text-blue-900 rounded-xl flex items-center gap-3 transition-all hover:scale-105 shadow-lg border-0"
                  onClick={() => {
                ...
                >
                  ...
                  <div className="flex flex-col items-start">
                    <span className="text-[10px] uppercase tracking-wider font-bold text-blue-900/60">Download Now</span>
              ...
              <div className="relative mx-auto border-gray-900 bg-gray-900 border-[14px] rounded-[2.5rem] h-[600px] w-[300px] shadow-2xl lg:rotate-[-6deg] lg:hover:rotate-0 transition-all duration-500">
                ...
                <div className="rounded-[2rem] overflow-hidden w-full h-full bg-white flex flex-col relative">
                  ...
                  <div className="bg-blue-600 p-6 pt-12 text-white">
                    ...
                    <p className="text-blue-100 text-sm">Find your specialist</p>
                  </div>
                  <div className="p-4 space-y-4 bg-gray-50 flex-1">
                    <div className="h-24 bg-white rounded-xl shadow-sm p-3 flex gap-3 items-center">
                    ...
                    <div className="h-32 bg-blue-600/5 rounded-xl border border-blue-100 p-4">
                      <div className="h-4 bg-blue-200 rounded w-1/2 mb-3"></div>
                      <div className="h-2 bg-blue-100 rounded w-full mb-2"></div>
